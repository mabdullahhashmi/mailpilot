...
Route::prefix('api/warmup')->middleware(['auth', 'throttle:120,1'])->group(function () {
    ...
    Route::post('campaigns/bulk-delete', [\App\Http\Controllers\Api\WarmupCampaignController::class, 'bulkDestroy']);
    ...
    Route::post('system-health/clear-pending-tasks', [\App\Http\Controllers\Api\SystemHealthController::class, 'clearPendingTasks']);
