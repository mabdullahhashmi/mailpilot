    ...
    <div class="flex h-full">
        ...
        <aside class="fixed inset-y-0 left-0 z-40 flex flex-col transition-all duration-300"
            ...
            <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('dashboard.campaign-flow') }}" class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-zinc-400 {{ request()->routeIs('dashboard.campaign-flow') ? 'active' : '' }}">
                    <i data-lucide="git-merge" class="w-5 h-5 flex-shrink-0"></i>
                    <span x-show="sidebarOpen" x-transition>Campaign Flow Test</span>
                </a>
